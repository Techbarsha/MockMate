...
export default function InterviewSettings({ onStartInterview, onResumeUpload }: InterviewSettingsProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      >
        <h2 className="text-3xl font-bold text-gray-900">Customize Your Interview</h2>
        ...
        {/* Free AI Badge */}
        <div className="mt-4">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-50 to-blue-50 text-green-700 rounded-full border border-green-200">
      ...
      {showApiKeySection && (
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-blue-900">Hugging Face API Key (Optional)</h3>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Voice Accent</h3>
                </div>
        ...
        <div className="space-y-6">
          ...
          >
            <h4 className="font-semibold text-green-900 mb-3">💡 Quick Tips</h4>
